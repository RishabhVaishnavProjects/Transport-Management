...
<?php
$place_r = $appr_to = $complete = $rc_from = "";
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
	...
	RECIEVED FROM:-</td><td><input type="text" name="rc" value="<?php echo $recived_from ?>"/><span class="error">* </td><td><?php echo $rc_error;?></br>
	PLACE-REACHED:-</td><td><input type="text" name="pr" value="<?php echo $place_reached ?>"/><span class="error">* </td><td><?php echo $p_error;?></br>
	APPROACHING-TO:-</td><td><input type="text" name="at" value="<?php echo $approachig_to ?>"/><span class="error">* </td><td><?php echo $a_error;?></br>
	SERIVCE COMPLETE:-</td><td><input type="text" name="sc" value="<?php echo $service ?>"/><span class="error">* </td><td><?php echo $complete_error?></br>
