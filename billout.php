...
echo "<table border = 1 >";
echo "<tr>";
echo "<td>basic amount with transportation cost and packaging charges:-</td><td>".$basic_amount3."</td>";
echo "</tr>";
echo "<tr>";
echo "<td>Weight Charge:-</td><td>".$weight_charge."</td>";
echo "</tr>";
echo "<tr>";
echo "<td>Amount after adding Weight chareges:-</td><td>".$basic_amount4."</td>";
echo "</tr>";
echo "<tr>";
echo "<td>16% VAT chareges:-</td><td>".$vat_tax."</td>";
echo "</tr>";
echo "<tr>";
echo "<td>10% SERVICE chareges:-</td><td>".$service_tax."</td>";
echo "</tr>";
echo "<tr>";
echo "<td>TOTAL AMOUNT TO BE PAID:-</td><td>".$basic_amount5."</td>";
echo "</tr>";
echo "</table>";
echo "</center>";
